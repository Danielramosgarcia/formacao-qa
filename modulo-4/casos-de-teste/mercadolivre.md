...
|------|------|-------------------|--------|----------------------| -------- |
| 1 | Buscar por “notebook” | exibir o texto “notebook” e realizar a pesquisa | Passou | conforme esperado | ![print](modulo-4/evidencias/mercadolivre/busca-notebook.png) |
