...
|------|------|-------------------|--------|----------------------| -------- |
| 1 | Buscar por “notebook” | exibir o texto “notebook” e realizar a pesquisa | Passou | conforme esperado | ![print](formacao-qa/modulo-4/evidencias/mercadolivre/busca-notebook.png) |
